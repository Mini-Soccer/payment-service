...
type IPaymentRepository interface {
	...
	Create(context.Context, *gorm.DB, *dto.PaymentRequest) (*models.Payment, error)               // pakai transaction
	Update(context.Context, *gorm.DB, string, *dto.UpdatePaymentRequest) (*models.Payment, error) // pakai transaction
}
